...
```
(ns my-namespace (:require [user-protocols.api :refer [check-user-contact]]))

(user-protocols.api/check-user-contact ...)
(check-user-contact                    ...)
```
...
```
(ns my-namespace (:require [user-protocols.api :refer [drop-user-session]]))

(user-protocols.api/drop-user-session ...)
(drop-user-session                    ...)
```
...
```
(ns my-namespace (:require [user-protocols.api :refer [send-security-code-authenticated]]))

(user-protocols.api/send-security-code-authenticated ...)
(send-security-code-authenticated                    ...)
```
...
```
(ns my-namespace (:require [user-protocols.api :refer [send-security-code-unauthenticated]]))

(user-protocols.api/send-security-code-unauthenticated ...)
(send-security-code-unauthenticated                    ...)
```
...
```
(ns my-namespace (:require [user-protocols.api :refer [update-user-contact]]))

(user-protocols.api/update-user-contact ...)
(update-user-contact                    ...)
```
...
```
(ns my-namespace (:require [user-protocols.api :refer [verify-security-code-authenticated]]))

(user-protocols.api/verify-security-code-authenticated ...)
(verify-security-code-authenticated                    ...)
```
...
```
(ns my-namespace (:require [user-protocols.api :refer [verify-security-code-unauthenticated]]))

(user-protocols.api/verify-security-code-unauthenticated ...)
(verify-security-code-unauthenticated                    ...)
```
...
```
(ns my-namespace (:require [user-protocols.api :refer [verify-user-password]]))

(user-protocols.api/verify-user-password ...)
(verify-user-password                    ...)
```
...
```
(ns my-namespace (:require [user-protocols.api :refer [verify-user-pin-code]]))

(user-protocols.api/verify-user-pin-code ...)
(verify-user-pin-code                    ...)
```
