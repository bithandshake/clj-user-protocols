...
- [check-user-identifier](#check-user-identifier)
...
- [send-security-code-authenticated](#send-security-code-authenticated)

- [send-security-code-unauthenticated](#send-security-code-unauthenticated)

- [update-user-account](#update-user-account)

- [update-user-contact](#update-user-contact)

- [update-username](#update-username)

- [verify-security-code-authenticated](#verify-security-code-authenticated)

- [verify-security-code-unauthenticated](#verify-security-code-unauthenticated)
...
```
(ns my-namespace (:require [user-security-protocols.api :refer [check-user-identifier]]))

(user-security-protocols.api/check-user-identifier ...)
(check-user-identifier                             ...)
```
...
```
(ns my-namespace (:require [user-security-protocols.api :refer [create-user-account]]))
...
```
(ns my-namespace (:require [user-security-protocols.api :refer [recover-user-password]]))

(user-security-protocols.api/recover-user-password ...)
(recover-user-password                             ...)
```
...
```
(ns my-namespace (:require [user-security-protocols.api :refer [remove-user-account]]))

(user-security-protocols.api/remove-user-account ...)
(remove-user-account                             ...)
```
...
```
(ns my-namespace (:require [user-security-protocols.api :refer [send-security-code-authenticated]]))

(user-security-protocols.api/send-security-code-authenticated ...)
(send-security-code-authenticated                             ...)
```
...
```
(ns my-namespace (:require [user-security-protocols.api :refer [send-security-code-unauthenticated]]))

(user-security-protocols.api/send-security-code-unauthenticated ...)
(send-security-code-unauthenticated                             ...)
```
...
```
(ns my-namespace (:require [user-security-protocols.api :refer [update-user-account]]))

(user-security-protocols.api/update-user-account ...)
(update-user-account                             ...)
```
...
```
(ns my-namespace (:require [user-security-protocols.api :refer [update-user-contact]]))

(user-security-protocols.api/update-user-contact ...)
(update-user-contact                             ...)
```
...
```
(ns my-namespace (:require [user-security-protocols.api :refer [update-username]]))

(user-security-protocols.api/update-username ...)
(update-username                             ...)
```
...
```
(ns my-namespace (:require [user-security-protocols.api :refer [verify-security-code-authenticated]]))

(user-security-protocols.api/verify-security-code-authenticated ...)
(verify-security-code-authenticated                             ...)
```
...
```
(ns my-namespace (:require [user-security-protocols.api :refer [verify-security-code-unauthenticated]]))

(user-security-protocols.api/verify-security-code-unauthenticated ...)
(verify-security-code-unauthenticated                             ...)
```
...
```
(ns my-namespace (:require [user-security-protocols.api :refer [verify-user-password]]))

(user-security-protocols.api/verify-user-password ...)
(verify-user-password                             ...)
```
...
```
(ns my-namespace (:require [user-security-protocols.api :refer [verify-user-pin-code]]))

(user-security-protocols.api/verify-user-pin-code ...)
(verify-user-pin-code                             ...)
```
