...
- [check-user-contact](#check-user-contact)
...
```
(ns my-namespace (:require [user-security-protocols.api :refer [check-user-contact]]))

(user-security-protocols.api/check-user-contact ...)
(check-user-contact                             ...)
```
